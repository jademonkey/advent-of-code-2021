...
func TestReadBingoInput(t *testing.T) {
	...
	Bingo1 := BingoCard{Numbers: BingoCard1Nums, MarkedNumbers: BingoCard1Mark}
	Bingo2 := BingoCard{Numbers: BingoCard2Nums, MarkedNumbers: BingoCard2Mark}
	Bingo3 := BingoCard{Numbers: BingoCard3Nums, MarkedNumbers: BingoCard3Mark}
